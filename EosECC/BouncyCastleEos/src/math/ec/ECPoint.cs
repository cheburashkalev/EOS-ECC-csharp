...
namespace Org.BouncyCastle.Math.EC
{
    ...
    public abstract class ECPoint
    {
        ...
        public virtual bool IsInfinityEOS
        {
            get { return m_x == null && m_y == null; }
        }
        public virtual bool IsOnCurveEOS
        {
            get { return true; }
        }
        ...
        public virtual bool IsValidEOS()
        {
            return IsValid();
        }
        ...
        public virtual bool EqualsEOS(ECPoint other) 
        {
            return Equals(other);
        }
        ...
        public virtual ECPoint TwiceEOS()
        {
            return Twice();
        }
        public virtual ECPoint AddEOS(ECPoint b)
        {
            return Add(b);
        }
        public abstract ECPoint Multiply(BigInteger b);
        public virtual ECPoint MultiplyEOS(BigInteger b)
        {
            return Multiply(b);
        }
